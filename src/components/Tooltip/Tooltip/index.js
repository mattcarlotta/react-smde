	...
	& .TooltipArrow {
		...
		${({ container, placement }) => {
			switch (placement) {
				...
				case "right":
					return `top: ${container.height}px;left: -5px;transform: translateY(-50%);`;
				case "left":
					return `top: ${container.height}px;right: -5px;transform: translateY(-50%);`;
				default:
		...
		&::before {
			...
			transform: ${({ placement }) => {
				switch (placement) {
					case "bottom":
						return "translateY(6.5355px) rotate(45deg)";
					case "right":
						return "translateX(6.5355px) rotate(45deg)";
					case "left":
						return "translateX(-6.5355px) rotate(45deg)";
					default:
						return "translateY(-6.5355px) rotate(45deg)";
